...
class FCustomVertexResourceArray :
	public FResourceArrayInterface
{
public:
	FCustomVertexResourceArray(const void* InData, uint32 InSize)
		: Data(InData)
		, Size(InSize)
	{
	}
...
protected:
	void InitWith(const void* InVertexData, uint32 InNumVerts, uint32 InSizeInBytes)
	{
		...
		FCustomVertexResourceArray ResourceArray(InVertexData, InSizeInBytes);
...
class FCustomColorVertexBuffer :
	public FCustomVertexBufferBase
{
public:
...
class FCustomLocationVertexBuffer :
	public FCustomVertexBufferBase
{
public:
...
public:
	...
	FCustomIndexBuffer(uint32 InNumPoints)
